...
<html>
<head>
    <title>JazebAkram.com Template</title>
 ...
 <link rel="stylesheet" href="CSS/Basic.css">
    <style>
#menu{
    background: rgb(200, 200, 200) url("images/pattern.png") repeat scroll 0 0;
...
section.links h3{
    background: #5D0580 url("images/pattern.png") repeat scroll 0 0;
    color: white;
    padding-left:10px;
    font-family: Bitter,Georgia,Times,"Times New Roman",serif;
    font-size: 1.9em;
...
<div class="clear"></div> 
    ...
    <section class="links">
	   ...
	   <br><br><br><br><br>
	   	    <section class="sideimage">
	    <img src="images/dark_knight.jpg" width="270" height="120" alt=""/>
	    
	    <h4 style="background: url(images/pattern.png);">Dark Knight Return</h4>
	   <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. <a href="#">More</a>
	   </p></section><br><br><br><br><br>
	    <br>
	   <div class="clear"></div>
	   <section class="sideimage">
	   ...
	   <div class="clear"></div>
	   	    <section class="sideimage">
	    <img src="images/Inception.jpg" width="270" height="120" alt=""/>
	    
	    <h4 style="background: url(images/pattern.png);">Inception</h4>
	   <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. <a href="#">More</a>
	   </p></section>
	...
	copies other then <br>&trade; jazebakram.com&copy; &trade;  Udemy ; &trade; Skillshare ; &trade; StackSkills</p><hr>
